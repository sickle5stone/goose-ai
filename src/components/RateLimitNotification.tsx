  ...
  useEffect(() => {
    ...
    const updateTimeLeft = () => {
      ...
      if (diff <= 0) {
        ...
        setTimeout(onClose, 1000); // Auto close after showing "Now available!"
        return;
      }
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-red-700">
                <p>
                  You've reached your hourly limit. You can continue chatting in{" "}
